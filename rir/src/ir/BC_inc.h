...
class BC {
  public:
    ...
    inline size_t popCount() {
        ...
        if (bc == Opcode::static_call_ || bc == Opcode::dispatch_eager_)
    ...
    bool isCallsite() const {
        return bc == Opcode::call_implicit_ ||
               bc == Opcode::dispatch_implicit_ || bc == Opcode::call_ ||
               bc == Opcode::dispatch_eager_ || bc == Opcode::static_call_;
    }

    bool hasPromargs() const {
        return bc == Opcode::call_implicit_ ||
               bc == Opcode::dispatch_implicit_ || bc == Opcode::promise_ ||
...
#include "insns.h"
    ...
    inline static ImmediateT decodeImmediate(Opcode bc, Opcode* pc) {
        ...
        case Opcode::subassign2_:
            ...
            break;
        case Opcode::dispatch_eager_:
        case Opcode::call_implicit_:
        case Opcode::dispatch_implicit_:
        case Opcode::call_:
